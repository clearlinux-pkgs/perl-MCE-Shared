...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARIOROY/MCE-Shared-1.891.tar.gz
...
%description
## MCE::Shared for Perl
This document describes MCE::Shared version 1.891.
### Description
...
%prep
%setup -q -n MCE-Shared-1.891
cd %{_builddir}/MCE-Shared-1.891
pushd ..
cp -a MCE-Shared-1.891 buildavx2
popd
