...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARIOROY/MCE-Shared-1.893.tar.gz
...
%prep
%setup -q -n MCE-Shared-1.893
cd %{_builddir}/MCE-Shared-1.893
pushd ..
cp -a MCE-Shared-1.893 buildavx2
popd
