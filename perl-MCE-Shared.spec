...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARIOROY/MCE-Shared-1.887.tar.gz
...
%prep
%setup -q -n MCE-Shared-1.887
cd %{_builddir}/MCE-Shared-1.887
pushd ..
cp -a MCE-Shared-1.887 buildavx2
popd
